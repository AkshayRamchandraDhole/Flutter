...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar : AppBar(
          title: const Text("Container Assignment1"),
        ),
        body: Center(
          child: Container(
            height: 120,
            ...
            decoration: BoxDecoration(
              color: Color.fromRGBO(2,147,178,1),
