            ...
            const SizedBox(
             ...
             Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: (){
                  doedit ? sumbit(doedit,toDoModelObj) : Navigator.of(context).pop();
                },
...
void sumbit(bool doedit, [ToDoModelClass? toDoModelObj]){
  if(titleontroller.text.trim().isNotEmpty && 
  ...
  dateController.text.trim().isNotEmpty){
    ...
    if(!doedit){
        setState(() {
          todoList.add(
            ToDoModelClass(
              title: titleontroller.text.trim(),
      ...
      setState(() {
        ...
        toDoModelObj.title = titleontroller.text.trim();
...
//  TO CLEAR THE ALL TEXT EDITING CONTROLLERS

void clearController(){
  titleontroller.clear();
...
void editTask(ToDoModelClass toDoModelobj){
  //ASSIGN  THE TEXT EDITNG CONTROLLER WITH THE TEXT VALUES AND 
  // THEN OPEN THE BOTTOM SHEET 

  titleontroller.text = toDoModelobj.title;
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: const[
                  ...
                  // BoxShadow(
                  //   offset: Offset(0, 10),
                  //   color: Colors.fromRGBO(0, 0, 0, 0.1);
                  //   blurRadius: 10,
                  // ),
                ],
                borderRadius: BorderRadius.circular(10),
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                fontWeight: FontWeight.w600,
                                fontSize: 15,
                                color: const Color.fromRGBO(0, 0, 0, 10.0),
                              ...
                              Text(
                                ...
                                fontSize: 12,
                                color: const Color.fromRGBO(84, 84, 84, 10.0),
                              )
                              ),
